 ...
 while($line = <>)
  {
    ...
    @csv_line =  (  "\\N",   $src_ip,  # src_ip
		       ...
		       $main::field[51],       #dst_packets
                       ...
                       $main::field[96],       #src_internal
                       is_internal($main::field[44]), # dst_internal
                       $main::field[97],       #conn_type
                       $main::field[98],       #p2p_type
                       $main::field[100],       #ed2k_data
		       $main::field[101],      #ed2k_sig
		       $main::field[102],      #ed2k_c2s
		       $main::field[103],      #ed2k_s2c
		       $main::field[104],      #ed2k_msg
		       $main::field[20],       #src_max_seg_size
		       $main::field[64],       #dst_max_seg_size
                       $main::html{$main::field[105]},  # HTML classification
		       );
