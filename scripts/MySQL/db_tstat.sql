...
CREATE TABLE tcp (
  ...
  html enum ("NONE","GET","POST","MSN","RTMPT","YOUTUBE","GOOGLEVIDEO","VIMEO","WIKI","RAPIDSHARE","MEGAUPLOAD","FACEBOOK","ADV","FLICKR","GMAPS","VOD") NOT NULL  default "GET",
  PRIMARY KEY  (id),
...
CREATE TABLE udp (
  ...
  src_packet int(10) unsigned default NULL,
  src_internal tinyint(1) default NULL,
  src_type enum("unknown","ed2k","kad","kadu","okad","gnu","bt","dc","kazaa","rtp","rtcp","skype_e2e","skype_out","skype_sig","pplive","sopcast","tvants","dns") NOT NULL default "unknown",
  dst_ip int(10) unsigned NOT NULL default "0",
  dst_port smallint(5) unsigned NOT NULL default "0",
  ...
  dst_packet int(10) unsigned default NULL,
  dst_internal tinyint(1) default NULL,
  dst_type enum("unknown","ed2k","kad","kadu","okad","gnu","bt","dc","kazaa","rtp","rtcp","skype_e2e","skype_out","skype_sig","pplive","sopcast","tvants","dns") NOT NULL default "unknown",
  PRIMARY KEY  (id),
  KEY idx_src_ip (src_ip),
  KEY idx_src_port (src_port),
  KEY idx_dst_ip (dst_ip),
